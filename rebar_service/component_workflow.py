...
class WorkflowConfig:
    ...
    solver_timeout: Optional[float] = field(default_factory=lambda: _env_optional_float("REBAR_SOLVER_TIMEOUT", None))
    solver_time_limit: Optional[float] = field(default_factory=lambda: _env_optional_float("REBAR_SOLVER_TIME_LIMIT", None))
    ...
    fit_time_limit: Optional[float] = field(default_factory=lambda: _env_optional_float("REBAR_FIT_TIME_LIMIT", None))
